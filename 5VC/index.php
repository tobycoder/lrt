...
<html>
  ...
  <p><body>
    <h1>Vind je maatje en je boekje voor 5VC</h1>
...
<?php
  ...
  $sql="SELECT  Naam, Boek1, Boek2, Boek3, Boek4 FROM boekjes2 WHERE Boek1 LIKE '%" . $query .  "%' OR Boek2 LIKE '%" . $query ."%' OR Boek3 LIKE '%" . $query .  "%' OR Boek4 LIKE '%" . $query .  "%'";
